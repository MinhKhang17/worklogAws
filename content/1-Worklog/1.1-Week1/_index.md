...
* Mẫu thiết kế bảo mật `.env` được thiết lập — không mã hóa cứng (hardcode) thông tin xác thực. (Thêm URL backend và chuẩn bị các biến môi trường cho CloudFront distribution CDN).
