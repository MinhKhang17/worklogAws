...
![AI Agent Workflow](/worklogAws/images/4-Event/Agent.png "AI Agent Architecture")
...
![Prompt Structure and AWS Architecture](/worklogAws/images/4-Event/prompt.png "Prompt Engineering & AWS")
...
![Hardware and AWS Architecture for AIoT](/worklogAws/images/4-Event/AIot.png "AIoT Smart Locker Architecture")

#### Some event photos

![Event Check-in](/worklogAws/images/4-Event/event1a.jpg "Check-in")
![Photo with speakers](/worklogAws/images/4-Event/event1b.jpg "Networking")
