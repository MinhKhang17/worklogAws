...
```markdown
![Minion](https://octodex.github.com/worklogAws/images/minion.png)
```
...
[id]: https://octodex.github.com/worklogAws/images/dojocat.jpg "The Dojocat"
...
```markdown
![Minion](https://octodex.github.com/worklogAws/images/minion.png?width=20pc)
```

![Minion](https://octodex.github.com/worklogAws/images/minion.png?width=20pc)

```markdown
![Minion](https://octodex.github.com/worklogAws/images/minion.png?height=50px)
```

![Minion](https://octodex.github.com/worklogAws/images/minion.png?height=50px)

```markdown
![Minion](https://octodex.github.com/worklogAws/images/minion.png?height=50px&width=300px)
```
...
```markdown
![Minion](https://octodex.github.com/worklogAws/images/minion.png?featherlight=false)
```
